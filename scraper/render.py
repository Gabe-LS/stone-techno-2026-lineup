...
def render_output_html(
    ...
    parts.append(
        '  <script defer src="https://analytics.deftlab.dev/script.js" data-website-id="8f79ad80-e080-421d-91c6-45b7bfc460d2" data-domains="stonetechno.deftlab.dev" data-performance></script>'
    )
